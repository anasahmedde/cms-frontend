...
export const API = {
  GROUP: process.env.REACT_APP_API_GROUP_BASEURL || `http://${HOST}:8005`,
  SHOP: process.env.REACT_APP_API_SHOP_BASEURL || `http://${HOST}:8005`,
  VIDEO: process.env.REACT_APP_API_VIDEO_BASEURL || `http://${HOST}:8005`,
